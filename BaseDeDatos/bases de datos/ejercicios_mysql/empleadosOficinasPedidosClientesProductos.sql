create database if not exists Ejercicios charset utf8mb4 collate utf8_unicode_ci;
...
numclie char(4),
numemp char(3),
constraint pk_cli_emp primary key(numclie,numemp),
constraint fk_cli_emp_Cli foreign key(numclie) references clientes(numclie)
on delete cascade on update cascade,
constraint fk_cli_emp_Emp foreign key(numemp) references empleados(numemp)
on delete cascade on update cascade
);*/

-- dam jos prymary key con drop table in cu clic dreapta;
create table clientes_empleados
(
numclie char(4),
numemp char(3),
...
insert into clientes_empleados values
('2101','101'),
('2102','103'),
('2103','105'),
('2105','104'),
...
-- atentie, tb sa am aceleasi date in tabela parinte, nu valori noi;
